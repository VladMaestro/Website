	...
	return (
		<section>
			<div className="article__container">
				<h1 className="article__title">Privacy Policy of www.easyenprep.com/</h1>
				...
				<h2 className="article__h2">Owner and Data Controller</h2>
				<p className="article__text">EASY EN Calle Doctor Barraquer 20, 3-izquierda, Almería, España. 04005</p>
				<p className="article__text">
					<b>Owner contact email:</b> vlad.shapoval.teacher@gmail.com
				</p>
				<h2 className="article__h2">Types of Data collected</h2>
				<p className="article__text">The owner does not provide a list of Personal Data types collected.</p>
				<p className="article__text">
				...
				<p className="article__text">
					...
					Cookies – or of other tracking tools – by this Application or by the owners of third-party services used by
				...
				<h2 className="article__h2">Mode and place of processing the Data</h2>
				<h3 className="article__h3">Methods of processing</h3>
				<p className="article__text">
				...
				<p className="article__text">
					...
					Data may be accessible to certain types of persons in charge, involved with the operation of this Application
				...
				<h3 className="article__h3">Legal basis of processing</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">Place</h3>
				<p className="article__text">
				...
				<h2 className="article__h2">The rights of Users</h2>
				<p className="article__text">Users may exercise certain rights regarding their Data processed by the Owner.</p>
				<p className="article__text">In particular, Users have the right to do the following:</p>
				<ul className="article__list">
					<li>
					...
					<li>
						Receive their Data and have it transferred to another controller. Users have the right to receive their Data
				...
				<h3 className="article__h3">Details about the right to object to processing</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">How to exercise these rights</h3>
				<p className="article__text">
				...
				<h2 className="article__h2">Additional information about Data collection and processing</h2>
				<h3 className="article__h3">Legal action</h3>
				<p className="article__text">
					The User&apos;s Personal Data may be used for legal purposes by the Owner in Court or in the stages leading to
					possible legal action arising from improper use of this Application or the related Services. The User declares
					to be aware that the Owner may be required to reveal personal data upon request of public authorities.
				</p>
				<h3 className="article__h3">Additional information about User&apos;s Personal Data</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">System logs and maintenance</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">Information not contained in this policy</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">How “Do Not Track” requests are handled</h3>
				<p className="article__text">
					This Application does not support “Do Not Track” requests. To determine whether any of the third-party
					services it uses honor the “Do Not Track” requests, please read their privacy policies.
				</p>
				<h3 className="article__h3">Changes to this privacy policy</h3>
				<p className="article__text">
				...
				<h2 className="article__h2">Definitions and legal references</h2>
				<h3 className="article__h3">Personal Data (or Data)</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">Usage Data</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">User</h3>
				<p className="article__text">
					The individual using this Application who, unless otherwise specified, coincides with the Data Subject.
				</p>
				<h3 className="article__h3">Data Subject</h3>
				<p className="article__text">The natural person to whom the Personal Data refers.</p>
				<h3 className="article__h3">Data Processor (or Data Supervisor)</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">Data Controller (or Owner)</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">This Application</h3>
				<p className="article__text">The means by which the Personal Data of the User is collected and processed.</p>
				<h3 className="article__h3">Service</h3>
				<p className="article__text">
					The service provided by this Application as described in the relative terms (if available) and on this
					site/application.
				</p>
				<h3 className="article__h3">European Union (or EU)</h3>
				<p className="article__text">
				...
				<h3 className="article__h3">Legal information</h3>
				<p className="article__text">
					This privacy statement has been prepared based on provisions of multiple legislations, including Art. 13/14 of
					Regulation (EU) 2016/679 (General Data Protection Regulation). This privacy policy relates solely to this
					Application, if not stated otherwise within this document.
				</p>
				<small>Latest update: October 06, 2022</small>
			</div>
		</section>
	);
};
